...
!(function (e, t) {
  ...
  function d(e, t) {
    ...
    var o = r(n);
    return (
      (n = e ? [o].concat(o.visualViewport || []) : n),
      (t = t.concat(n)),
      e ? t : t.concat(d(u(n)))
    );
  }
  ...
  function w(e) {
    ...
    return function (e, t, i) {
              ...
              s.orderedModifiers.forEach(function (e) {
                ...
                (r = void 0 === r ? {} : r),
                  "function" == typeof (e = e.effect) &&
                    ((t = e({ state: s, name: t, instance: l, options: r })),
                    f.push(t || function () {}));
              }),
              l.update()
            );
                ...
                for (
                  ...
                  if (!0 === s.reset) (s.reset = !1), (t = -1);
                    ...
                    (n = void 0 === n ? {} : n),
                      ...
                      "function" == typeof e &&
                        (s =
                          e({ state: s, options: n, name: r, instance: l }) ||
                          s);
                  }
            }
          },
      ...
      return y(e, t)
        ? (l.setOptions(i).then(function (e) {
  ...
  function M(e) {
    ...
    return (
      (n = Object.assign({ position: f }, c && V)),
      p
        ? Object.assign(
            {},
            n,
    ...
    return (
      (t =
        "clippingParents" === t
          ? (function (e) {
              var t = d(e),
                r =
                  0 <= ["absolute", "fixed"].indexOf(l(e).position) && i(e)
                    ? h(e)
                    : e;
              return o(r)
                ? t.filter(function (e) {
      ...
      ((n = (n = [].concat(t, [n])).reduce(function (t, n) {
        ...
        var h = f(n),
          ...
          g = n.clientHeight + d;
        return (
          c && 50 < p.innerHeight - n.clientHeight && (g = p.innerHeight - d),
          (d = c ? 0 : n.clientTop),
          (u =
            n.clientLeft > m
              ? u
  ...
  function H(e, r) {
    ...
    var p = n.altBoundary,
      c = void 0 !== p && p;
    n = B(
      "number" != typeof (n = void 0 === (n = n.padding) ? 0 : n) ? n : W(n, R)
    );
    ...
    U = [
      {
        ...
        effect: function (e) {
          ...
          return (
            ...
            a && s.addEventListener("resize", n.update, N),
            function () {
              i &&
                f.forEach(function (e) {
        ...
        fn: function (e) {
          ...
          if (((e = e.name), !t.modifiersData[e]._skip)) {
            ...
            for (var d = u[0], m = 0; m < u.length; m++) {
              ...
              if (
                ((g = y ? (g ? "right" : "left") : g ? "bottom" : "top"),
                n[w] > r[w] && (g = j(g)),
                (w = j(g)),
                (v = [0 >= x[v], 0 >= x[g], 0 >= x[w]]).every(function (e) {
                  return e;
                }))
              ) {
                (d = h), (f = !1);
        ...
        fn: function (e) {
          ...
          if (((s = { x: 0, y: 0 }), l)) {
            if (o) {
              ...
              (g = D[g]),
                (y = D[y]),
                (m = Math.max(0, Math.min(d[w], m[w]))),
                (E = p ? d[w] / 2 - j - m - g - v : E - m - g - v),
                (p = p ? -d[w] / 2 + j + m + y + v : f + m + y + v),
        ...
        fn: function (e) {
          ...
          if (
            ...
            (u =
              ...
              n[i] / 2 +
              (u / 2 - o / 2)),
              (i = Math.max(s[f], Math.min(u, l - n[i] - s[p]))),
              (r.modifiersData[e] =
