...
class PostUpdateViewTestCase(TestCase):
    def setUp(self):
        ...
        self.username = 'duc'
        self.password = '123'
        user = User.objects.create_user(username=self.username, email='duc@gmail.com',password=self.password)
...
class LoginRequredPostUpdateViewTest(PostUpdateViewTestCase):
